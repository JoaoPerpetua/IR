...
int main( int argc, char *argv[] ) {
    ...
    */
    while(1){
    	...
    	char *welcome = "Welcome to the server, your Host ID is ="+HostID;
    	char *totalclient = "Nº of total clients = "+nclients;
    	// Send a response to the client 
    	n = send(newsockfd, welcome, strlen(welcome), 0);
    	n = send(newsockfd, totalclient, strlen(totalclient),0);
    	if (n < 0) {
